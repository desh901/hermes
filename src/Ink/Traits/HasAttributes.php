...
use Hermes\Core\Exceptions\JsonEncodingException;
...
trait HasAttributes
{
    ...
    /**
     * The representation format of the object's date attributes.
     *
     * @var string
     */
    ...
    public function attributesToArray()
    {
        ...
        // formatting while accessing attributes vs. arraying / JSONing an object.
        ...
        // Here we will grab all of the appended, calculated attributes to this object
    ...
    protected function addCastAttributesToArray(array $attributes, array $mutatedAttributes)
    {
        foreach ($this->getCasts() as $key => $value) {
            ...
            // to strings based on the date format specified for these Ink objects.
    ...
    /**
     * Get the objects's relationships in array form.
     *
     * @return array
     */
    public function relationsToArray()
    {
        ...
        foreach ($this->getArrayableRelations() as $key => $value) {
            ...
            // if it a has one or belongs to type relationships on the objects.
    ...
    public function getAttribute($key)
    {
        ...
        // Here we will determine if the object base class itself contains this given key
    ...
    public function getRelationValue($key)
    {
        ...
        // If the "attribute" exists as a method on the object, we will just assume
    ...
    public function setAttribute($key, $value)
    {
        ...
        // the object, such as "json_encoding" an listing of data for storage.
    ...
    /**
     * Get the object's original attribute values.
     *
    ...
    /**
     * Set the accessors to append to object arrays.
     *
     * @param  array  $appends
     * @return $this
     */
